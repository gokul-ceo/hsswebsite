...
function Tc(props) {
  return (
    <>
      <div className={style.tcmaindiv}>
        <h1>Terms & Conditions</h1>
        <h2>Overview</h2>
        <p>
          This website is operated by Sri Saravana Restaurant. Throughout the
          site, the terms “we,” “us” and “our” refer to Sri Saravana Restaurant.
          Sri Saravana Restaurant offers this website, including all
        ...
        <hr />
        <h3>Online Order Terms</h3>
        <div>
          <p>
            You represent that you are at least the age of majority in your
            state or province of residence, or that you are the age of majority
            in your state or province of residence and if you are a minor, you
            must access and operate the Site only under the strict guidance and
            control of your guardian or parent. You may not use our products for
            ...
            limited to copyright laws). You must not transmit any bugs or
        ...
        <h3>Accuracy, completeness, and timeline of information</h3>
        <div>
          <p>
            ...
            the contents of this site at any time, but we have no obligation to
        ...
        <h3>Modification To the Service and Prices</h3>
        <div>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            rights. You further agree that your comments will not contain
        ...
        <div>
          <p>
            ...
            governed by our Privacy Policy. For more details, please review our{" "}
        ...
        <div>
          ...
          <p>
            ...
            case shall Sri Saravana Restaurant, our directors, officers,
        ...
        <div>
          <p>
            You agree to indemnify, defend and hold harmless Geetham Veg
            Restaurant and our subsidiaries, affiliates, partners, officers,
